...
Pre-designed presentation structures and templates for common use cases. Choose a recipe to get started with the right slide sequence, or use recipes as guidance for custom presentations.

---

## Contents
- [Recipe Structure](#recipe-structure)
- [Recipe 1: Product Launch](#recipe-1-product-launch--feature-announcement)
- [Recipe 2: Team Review](#recipe-2-internal-team-review--status-update)
- [Recipe 3: Proposal](#recipe-3-proposal--business-case)
- [Recipe 4: Training](#recipe-4-training--education)
- [Recipe 5: Quick Update](#recipe-5-quick-update--standup-lightweight)
- [How to Use Recipes](#how-to-use-recipes)

## Recipe Structure

Each recipe defines:
- **Purpose** — What the presentation is for
- **Audience** — Who will see it
- **Total Slides** — Expected length
- **Slide Sequence** — Exact order of slide types with templates
- **Content Flow** — How information progresses
- **Icon Strategy** — Which slides get icons and why
- **Tips** — Best practices for this recipe type

---

## Recipe 1: Product Launch / Feature Announcement

**Purpose:** Introduce a new product or major feature to market/stakeholders
**Audience:** Product team, executives, customers, media
...
### Content Flow
Problem → Solution → Features → Demo → Social Proof → Metrics → Roadmap → FAQ → CTA → Thanks

### Icon Strategy
- Start (1): No icons — focus on branding
- Middle (2-10): Add 15-20 total icons for visual interest
- End (11): No icons — professional close

### Tips
- Keep demo visual large (don't crowd with text)
- Use social proof slide if available (builds trust)
- Metrics should tell a story (growth/adoption/usage)
- FAQ answers should be brief (1-2 lines max)

---

## Recipe 2: Internal Team Review / Status Update

**Purpose:** Update team on progress, plans, or organizational change
**Audience:** Team members, managers, stakeholders
...
### Content Flow
Agenda → Context → Accomplishments → Metrics → Next Steps → Blockers → Request for Input → Thanks

### Icon Strategy
- Use 10-15 total icons
- Emphasize wins (checkmarks, stars) in middle
- Alert icons for challenges
- Communication icons for feedback

### Tips
- Lead with wins (positive momentum)
- Be transparent about blockers
- Invite feedback (don't just broadcast)
- Keep metrics relevant to team goals
- Agenda slide sets up sections (matches content order)

---

## Recipe 3: Proposal / Business Case

**Purpose:** Make a case for a project, initiative, or change
**Audience:** Decision-makers, executives, stakeholders
**Total Slides:** 12-18 slides
**Time:** 20-30 minutes
...
### Content Flow
Summary → Problem → Impact → Solution → Details → Timeline → Resources → Outcomes → Risk → Comparison → Success Criteria → Next Steps → Q&A → Thanks

### Icon Strategy
- Use 20-25 total icons
- Problem/Risk: Alert, Warning
- Solution: Lightbulb, Rocket, Tools
- Outcomes: Chart up, Trophy
- Timeline: Clock, Calendar
- Decision: Forward, Flag

### Tips
- Executive summary first (busy executives)
- Lead with business impact, not features
- Be honest about risks (build trust)
- Clear success criteria (not subjective)
- Include comparison if alternatives exist
- Request specific decision (not just feedback)

---

## Recipe 4: Training / Education

**Purpose:** Teach a topic or skill to an audience
**Audience:** Employees, teams, customers
**Total Slides:** 15-20 slides
**Time:** 30-45 minutes
...
### Content Flow
Objectives → Prerequisites → Lesson Content → Practice → Q&A → Resources → Thanks

### Icon Strategy
- Use 15-20 total icons
- Learning: Academy, Book, Lightbulb
- Practice: Checkmark, Target
- Questions: Help, Chat
- Resources: Link, Book

### Tips
- Clear learning objectives upfront
- Mix teaching methods (text, visuals, examples)
- Include practice/exercises (active learning)
- Provide resources for continued learning
- Allow time for questions

---

## Recipe 5: Quick Update / Standup (Lightweight)

**Purpose:** Brief status update or announcement
**Audience:** Team, stakeholders
**Total Slides:** 5-8 slides
**Time:** 5-10 minutes
...
### Content Flow
Updates → Metrics (optional) → Next Steps → Action Items (optional) → Thanks
...
- Optional metrics (include only if relevant)
...
Select recipe that matches your presentation purpose:
- **Product Launch** → Recipe 1
- **Team Status** → Recipe 2
- **Business Proposal** → Recipe 3
- **Training** → Recipe 4
- **Quick Update** → Recipe 5
...
1. Tell skill which recipe you're using
2. Skill will:
   - Suggest slide order
   - Recommend templates
   - Pre-select icons
...
Create your own recipe using this structure:
...
### Content Flow
[Describe how ideas progress]

### Icon Strategy
[How many icons, where, what types]

### Tips
[Best practices for this recipe]
```
...
**When generating with a recipe:**

1. **Phase 0** — User selects recipe
2. **Phase 1** — Skill suggests slide order from recipe
3. **Phase 1** — User maps content to suggested slides (can adjust)
4. **Phase 2** — Review & approval with recipe structure shown
5. **Phase 3** — Generate with:
   - Template pre-selected per recipe
   - Icon strategy applied
   - Slide sequence locked (unless user changes)
